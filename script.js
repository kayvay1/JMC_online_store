...
function createCard(item){
    ...
    buybutton.onclick = function(stoppropevent){  
        ...
        let sizeselected = selectedoption
    ...
    // card.onclick = function onclickCard(){
    //     console.log('card none ok')
    //     cards.style.display = 'none'
    //     let makeinnerdata = document.createElement('div')
    //     let clickoncard = document.getElementById('clickoncard')
    //     clickoncard.appendChild(makeinnerdata)

    //     document.getElementById('clickoncard').style.display = 'inline-block'

    //     document.getElementById('clickcardmainimg').src = item.item_img
    //     document.getElementById('cliccardimg1').src = item.item_img
    //     document.getElementById('cliccardimg2').src = item.item_img
    //     document.getElementById('cliccardimg3').src = item.item_img
    //     document.getElementById('cliccardimg4').src = item.item_img


    //     document.getElementById('clickoncardinput').value = index        
